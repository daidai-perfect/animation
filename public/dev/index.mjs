globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file:///Users/daihefang/Desktop/usually/cetus-cmm-app/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { provider, isWindows } from 'file:///Users/daihefang/Desktop/usually/cetus-cmm-app/node_modules/std-env/dist/index.mjs';
import { defineEventHandler, handleCacheHeaders, createEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseStatus, getRequestHeader, setResponseHeader, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, getQuery, createError } from 'file:///Users/daihefang/Desktop/usually/cetus-cmm-app/node_modules/h3/dist/index.mjs';
import { createRenderer } from 'file:///Users/daihefang/Desktop/usually/cetus-cmm-app/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import devalue from 'file:///Users/daihefang/Desktop/usually/cetus-cmm-app/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { createFetch as createFetch$1, Headers } from 'file:///Users/daihefang/Desktop/usually/cetus-cmm-app/node_modules/ofetch/dist/node.mjs';
import destr from 'file:///Users/daihefang/Desktop/usually/cetus-cmm-app/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file:///Users/daihefang/Desktop/usually/cetus-cmm-app/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Users/daihefang/Desktop/usually/cetus-cmm-app/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file:///Users/daihefang/Desktop/usually/cetus-cmm-app/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/daihefang/Desktop/usually/cetus-cmm-app/node_modules/defu/dist/defu.mjs';
import { hash } from 'file:///Users/daihefang/Desktop/usually/cetus-cmm-app/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, withQuery } from 'file:///Users/daihefang/Desktop/usually/cetus-cmm-app/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/daihefang/Desktop/usually/cetus-cmm-app/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/daihefang/Desktop/usually/cetus-cmm-app/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/daihefang/Desktop/usually/cetus-cmm-app/node_modules/radix3/dist/index.mjs';
...
const _runtimeConfig = {"app":{"baseURL":"/","buildAssetsDir":"/_nuxt/","cdnURL":""},"nitro":{"envPrefix":"NUXT_","routeRules":{"/__nuxt_error":{"cache":false}}},"public":{"appEnv":""}};
...
const serverAssets = [{"baseName":"server","dir":"/Users/daihefang/Desktop/usually/cetus-cmm-app/src/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/daihefang/Desktop/usually/cetus-cmm-app","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/daihefang/Desktop/usually/cetus-cmm-app/src/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/daihefang/Desktop/usually/cetus-cmm-app/dist","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/daihefang/Desktop/usually/cetus-cmm-app/dist/cache","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _lazy_2EGCyo = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_2EGCyo, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_2EGCyo, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('/Users/daihefang/Desktop/usually/cetus-cmm-app/dist/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
...
const _virtual__headStatic = {"headTags":"<meta charset=\"utf-8\">\n<meta name=\"viewport\" content=\"width=device-width, initial-scale=1, user-scalable=0\">\n<title>Cetus - Empower liquidity. Built for DeFi. </title>\n<meta name=\"keywords\" content=\"keywords\">\n<meta name=\"description\" content=\"Swap, earn, and build on the pioneer MOVE-based liquidity protocol.\">\n<link rel=\"icon\" type=\"image/x-icon\" href=\"/favicon.ico?t=1720765139467\">\n<script src=\"https://at.alicdn.com/t/c/font_3580402_4mwmi1y7lbw.js?spm=a313x.manage_type_myprojects.i1.13.29783a817PtgOl&file=font_3580402_4mwmi1y7lbw.js\"></script>","bodyTags":"","bodyTagsOpen":"","htmlAttrs":"","bodyAttrs":""};
